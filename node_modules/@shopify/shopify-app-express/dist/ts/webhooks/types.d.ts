...
export type WebhookHandlersParam = Record<string, WebhookHandler | WebhookHandler[]>;
...
export type ProcessWebhooksMiddleware = (params: ProcessWebhooksMiddlewareParams) => RequestHandler[];
