...
var httpFetch = require('../graphql-client/dist/graphql-client/http-fetch.js');
var utilities = require('../graphql-client/dist/graphql-client/utilities.js');
...
function createAdminRestApiClient({ storeDomain, apiVersion, accessToken, userAgentPrefix, logger, customFetchApi = fetch, retries: clientRetries = 0, scheme = "https", defaultRetryTime = constants.DEFAULT_RETRY_WAIT_TIME, formatPaths = true, }) {
    ...
    validations$1.validateServerSideUsage();
    ...
    validations$1.validateRequiredAccessToken(accessToken);
    utilities.validateRetries({ client: constants.CLIENT, retries: clientRetries });
    ...
    const request = async (path, { method, data, headers: requestHeadersObj, searchParams, retries = 0, apiVersion, }) => {
        ...
        return httpFetch$1([url, { method, headers, ...(body ? { body } : undefined) }], 1, retries ?? clientRetries);
    };
    return {
